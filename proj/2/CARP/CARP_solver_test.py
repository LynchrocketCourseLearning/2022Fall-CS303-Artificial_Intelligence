...
instances = ["./CARP_samples/egl-e1-A.dat", "./CARP_samples/egl-s1-A.dat", "./CARP_samples/gdb1.dat", "./CARP_samples/gdb10.dat", "./CARP_samples/val1A.dat", "./CARP_samples/val4A.dat", "./CARP_samples/val7A.dat"]
# instances = ["./CARP_samples/gdb1.dat", "./CARP_samples/gdb10.dat", "./CARP_samples/val1A.dat", "./CARP_samples/val4A.dat", "./CARP_samples/val7A.dat"]
# instances = ["./CARP_samples/egl-e1-A.dat"]
...
def main(args: argparse.ArgumentParser):
    ...
    for i in instances:
        ...
        random.seed(SEED)
        # routes, capacity_cost, total_cost = init_solution(demands)
        # print(get_res(routes, total_cost))
        routes, capacity_cost, total_cost = simulated_annealing(demands)
        print(get_res(routes, total_cost))
        print('time consuming: '+str(time.time()-st_time))
    # demands = parse_data(args)
    # random.seed(SEED)
    # # routes, capacity_cost, total_cost = init_solution(demands)
    # # print(get_res(routes, total_cost))
...
def simulated_annealing(demands: np.ndarray):
    ...
    print('initial cost: '+str(current[2]))
